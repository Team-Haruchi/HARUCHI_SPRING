...
public enum ErrorStatus implements BaseErrorCode {
    ...
    TARGET_NOT_NULL(HttpStatus.BAD_REQUEST, "REDISTRIBUTION4002", "타겟 날짜가 존재하지 않습니다."),
    INVALID_AMOUNT_RANGE(HttpStatus.BAD_REQUEST, "REDISTRIBUTION4003", "입력된 금액이 해당 예산 범위를 초과하거나 유효하지 않습니다."),
